...
export class AdminAreasComponent implements OnInit {
  ...
  addArea() {
    ...
    this.http.post<Area>(`${environment.apiUrl}/Areas`, this.newArea).pipe(
      catchError(err => {
  ...
  updateArea() {
    ...
    this.http.put<Area>(`${environment.apiUrl}/Areas/${this.editArea.areaId}`, this.editArea).pipe(
      catchError(err => {
  ...
  deleteArea(area: Area) {
    ...
    this.http.delete(`${environment.apiUrl}/Areas/${area.areaId}`).pipe(
      catchError(err => {
